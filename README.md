...
- Overall mentorship and documentation sample structures: [Iuliia Konovalova](https://github.com/IuliiaKonovalova/),
- Most of Playlists: by courtesy of Alex Kuievda - my son, guitarist and a Slipknot lover, for creating such brilliant themed Playlist collections,
- The idea on comment functionality, is taken from the Blog walkthrough project, particularly on the following:
   - design structure and layout ideas for user comment form
   - JavaScript code idea for manipulating DOM and pre-populating Comment form:
   owing to [Code Institute](https://codeinstitute.net/)
- Testing samples, fragments of Django signals are taken at [Very Academy](https://www.youtube.com/c/veryacademy) - probably one of the best on-line Django teachers, and from their [github](https://github.com/veryacademy)
- Ideas for like/unlike functionality are borrowed from [Codemy](https://codemy.com/) - from their amazing tutorials [like/unlike functionality](https://www.youtube.com/playlist?list=PLCC34OHNcOtr025c1kHSPrnP18YPB-NFi) in particular,
- Help in understanding signals in Django is taken at [CodingEntrepreneurs](https://www.youtube.com/watch?v=rEX50LJrFuU)

### Media

- All Playlist Images are downloaded from free Web Content
- Slipknot Data and discography information are taken from [Discogs](https://www.discogs.com/)
- Unique custom banners for the front page and the wallpaper is generated by Midjourney AI

### Design

- colors and spirit inspired by Slipknot sub-culture environment, web-site and photo galleries 
- overall design: color pallette, layouts and color scheme are inspired by sketches and patterns generated by [Midjourney](https://www.midjourney.com/home) 
- fonts are taken robust and simple: system-ui, sans-serif. The stack does not require import.
